...
Report category **A, provisional: possible evaluation/heatmap mapping bug flagged**. A confirmed mapping bug has not been demonstrated; categories B–F cannot be selected from the stopped probe. No router, q/k, initialization, loss, supervision or training changes were made. Stop for Review.
